...
def start(update, context):
    ...
    url_photo = 'https://cdn.discordapp.com/attachments/773955872979943503/821057561851592744/unknown.png'
...
def main():
    ...
    updater = Updater("1689996214:AAHkMNHQNooDiDN2VUx9vAdjGcmojcuS298", use_context=True)
